...
class AxisBar(gui.QWidget):
	def __init__(self,parent,priority,name=None):
		...
		self.inp_min_ramp_duration = gui.QLineEdit(self)
		self.inp_post_ramp_delay   = gui.QLineEdit(self)
		...
		self.layout.addWidget(self.header_priority,2)
		...
		self.layout.addWidget(self.inp_min_ramp_duration,6)
		self.layout.addWidget(self.inp_post_ramp_delay,6)
		self.layout.addWidget(self.btn_up,4)
		self.layout.addWidget(self.btn_down,4)
		self.layout.addWidget(self.btn_del,4)
		...
		self.inp_min_ramp_duration.textEdited.connect(self.parent.check_axes)
		self.inp_post_ramp_delay.textEdited.connect(self.parent.check_axes)
	...
	def delete(self):
		...
		self.inp_min_ramp_duration.textEdited.disconnect()
		self.inp_post_ramp_delay.textEdited.disconnect()
